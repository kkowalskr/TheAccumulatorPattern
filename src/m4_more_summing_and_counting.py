...
"""  # Kenny Kowalski: 1. PUT YOUR NAME IN THE ABOVE LINE.
...
def run_test_factorial():
    ...
    # Test 3:
    answer_from_oracle = math.factorial(55)
    answer_from_my_code = factorial(55)
    ...
    print('Test 5 expected (from oracle):', answer_from_hand)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
   ...
   # Test 2:
    ...
    # Test 5:
    expected = 3
    answer = count_cosines_from(3, 5, -10)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(7, 9, -0.2)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 2.08333  # This is APPROXIMATELY the correct answer.
